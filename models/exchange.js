module.exports = (sequelize, DataTypes) => {
    ...
    Exchange.belongsTo(models.MoneyType, { as: "PurchaseType",foreignKey: "purchaseMoneyType" });
    Exchange.belongsTo(models.MoneyType, {as: "SaleType", foreignKey: "saleMoneyType" });
  };
